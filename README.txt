...
- inst:
	...
	utilizzo:  verifica che il nome dell'istanza passatagli sia 
		   effettivamente un'istanza, se lo è la recupera dalla 
		   base di conoscenza e unifica il nome alla variabile 
		   passatagli.
